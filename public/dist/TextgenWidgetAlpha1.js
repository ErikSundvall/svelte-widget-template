var app2 = (function () {
    ...
    /* src\TextGenWidgetAlpha1.svelte generated by Svelte v3.59.2 */
    const file = "src\\TextGenWidgetAlpha1.svelte";

    // (91:0) {#if config && config.showTree === true}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(91:0) {#if config && config.showTree === true}",
    		ctx
    	});
    ...
    // (95:0) {#if config && config.showDebug === true}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 95, 0, 2881);
    			add_location(li0, file, 97, 4, 2935);
    			add_location(li1, file, 98, 4, 2984);
    			add_location(br0, file, 99, 24, 3065);
    			add_location(pre0, file, 99, 28, 3069);
    			add_location(li2, file, 99, 4, 3045);
    			add_location(br1, file, 100, 28, 3148);
    			add_location(pre1, file, 100, 32, 3152);
    			add_location(li3, file, 100, 4, 3124);
    			add_location(ul, file, 96, 0, 2925);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(95:0) {#if config && config.showDebug === true}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*config*/ ctx[1] && /*config*/ ctx[1].showTree === true && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			this.c = noop;
    			add_location(br0, file, 83, 26, 2466);
    			add_location(br1, file, 84, 57, 2529);
    			add_location(input, file, 85, 0, 2535);
    			add_location(br2, file, 85, 31, 2566);
    			add_location(button0, file, 87, 0, 2574);
    			add_location(button1, file, 88, 0, 2622);
    			add_location(div, file, 81, 0, 2407);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*config*/ ctx[1] && /*config*/ ctx[1].showTree === true) {
    				if (if_block0) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_slots('textgen-widget-alpha-1', slots, []);
    	let { config = { showTree: true, showDebug: false } } = $$props;
    	...
    	const descriptor = {
    		...
    		configuration: {
    			showTree: {
    				...
    				defaultValue: true,
    				metadata: {
    					title: 'Show a tree view of data (or not)'
    				}
    			},
    			showDebug: {
    				type: 'boolean',
     ...
     */
    	...
    	$$self.$$.on_mount.push(function () {
    		if (inputData === undefined && !('inputData' in $$props || $$self.$$.bound[$$self.$$.props['inputData']])) {
    			console.warn("<textgen-widget-alpha-1> was created without expected prop 'inputData'");
    		}
    	});
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<textgen-widget-alpha-1> was created with unknown prop '${key}'`);
    	});
    ...
    class TextGenWidgetAlpha1 extends SvelteElement {
    	constructor(options) {
    		super();
    	...
    	set descriptor(value) {
    		throw new Error("<textgen-widget-alpha-1>: Cannot set read-only property 'descriptor'");
    	}
    ...
    customElements.define("textgen-widget-alpha-1", TextGenWidgetAlpha1);

    // Add import of handlebars here

    return TextGenWidgetAlpha1;

})();
//# sourceMappingURL=TextgenWidgetAlpha1.js.map
